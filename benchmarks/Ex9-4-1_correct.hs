...
exampleQ1 = insert "nal" $ insert "bob" $ insert "alice" $ emp
test1 = exampleQ1 == Q (SL 3 ["alice","bob","nal"]) (SL 0 [])

{-@ exampleQ2 :: QueueN _ 4 @-}
exampleQ2 = insert 4 $ insert 3 $ insert 2 $ insert 1 $ emp
test2 = exampleQ2 == Q (SL 3 [1, 2, 3]) (SL 1 [4])