...
{-@ exampleQ1 :: QueueN _ 2 @-}
exampleQ1 :: Queue Int
exampleQ1 = Q (SL 2 [1, 2]) (SL 0 [])
test1 = makeq (SL 2 [1, 2]) (SL 0 []) == exampleQ1

{-@ exampleQ2 :: QueueN _ 3 @-}
exampleQ2 :: Queue Int
exampleQ2 = Q (SL 2 [1, 2]) (SL 1 [3])
test2 = makeq (SL 2 [1, 2]) (SL 1 [3]) == exampleQ2

-- {-@ exampleQ3 :: {v:_ | false} @-}
exampleQ3 :: Queue Int
exampleQ3 = makeq (SL 2 [1, 2]) (SL 1 [3])
test3 = exampleQ3 == undefined